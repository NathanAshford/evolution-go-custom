...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_EvolutionAPI_evolution-go_pkg_call_service.CallActionStruct"
                        }
                    }
                ],
                "responses": {
        ...
        "/call/audio/{callId}": {
            "get": {
                ...
                "description": "Opens a WebSocket carrying the call's audio in both directions as raw\n16 kHz mono signed 16-bit little-endian PCM in binary frames.\nBinary frames sent by the client are injected into the call as if they\ncame from a microphone; binary frames sent by the server are the peer's\naudio. Only one client may stream a given call at a time.",
                "tags": [
                    "Call"
                ],
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Call id returned by /call/offer",
                        "name": "callId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Call is not live",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
                    "409": {
                        "description": "Another client is already streaming this call",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    }
        ...
        "/call/hangup": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Call id and optional reason",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/call/offer": {
            "post": {
                ...
                "description": "Places an outgoing WhatsApp voice call. The peer's device rings and the\nreturned callId can be used to hang up. Audio is silence keep-alive —\nthe HTTP API rings and holds the call but does not stream microphone audio.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_EvolutionAPI_evolution-go_pkg_call_service.OfferCallStruct"
                        }
                    }
                ],
                "responses": {
        ...
        "/instance/logs/{instanceId}": {
            "get": {
                ...
                "description": "Returns the instance's log entries, newest first. All filters are optional:\nomitting them returns the most recent entries. Dates accept RFC3339\n(2026-01-31T00:00:00Z) or a bare YYYY-MM-DD.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Only entries at or after this moment (RFC3339 or YYYY-MM-DD)",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Only entries at or before this moment (RFC3339 or YYYY-MM-DD)",
                        "name": "end_date",
                        "in": "query"
                    },
                    {
        ...
        "/instance/proxy/{instanceId}": {
            "get": {
                ...
                "description": "Delete proxy\nReturns the proxy configuration saved for an instance (null when none is set)",
                "consumes": [
                    "application/json",
                    "application/json"
                ],
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "instanceId is required",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
        ...
        "/instance/proxy/{instanceId}/reconnect": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Reconnecting through proxy",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
                    "400": {
                        "description": "instanceId is required or no proxy configured",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
        ...
        "/instance/proxy/{instanceId}/test": {
            "post": {
                ...
                "description": "Checks whether a proxy works and reports the IP it exits from, without\ntouching the instance's live connection. Send a proxy in the body to test\none before saving it; send an empty body to test the instance's saved proxy.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "Proxy to test; omit to use the saved one",
                        "name": "proxy",
                        "in": "body",
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_EvolutionAPI_evolution-go_pkg_instance_service.ProxyTestResult"
                        }
                    },
                    "400": {
                        "description": "No proxy to test",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
        ...
        "/instance/webhooks/{instanceId}": {
            ...
            "post": {
                ...
                "description": "Registers one more URL to receive this instance's events. An instance may\nhave several webhooks and every one receives the same payload. Adding a URL\nthat is already registered is a no-op. The change applies immediately, with\nno need to reconnect the instance.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_instance_handler.AddWebhookBody"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "instanceId or url missing",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
    ...
    "definitions": {
        ...
        "github_com_EvolutionAPI_evolution-go_pkg_call_service.CallActionStruct": {
            "type": "object",
            "properties": {
                "callId": {
                    "description": "CallID as returned by POST /call/offer or the CallOffer webhook.",
                    "type": "string",
                    "example": "A1B2C3D4E5F6"
                },
                "reason": {
                    "description": "Reason is optional; defaults to user_ended (terminate) or declined (reject).",
                    "type": "string",
                    "example": "user_ended"
                }
            }
        },
        "github_com_EvolutionAPI_evolution-go_pkg_call_service.OfferCallStruct": {
            "type": "object",
            "properties": {
                "number": {
                    "description": "Recipient phone number with country code (digits only), or a full JID.",
                    "type": "string",
                    "example": "5511999999999"
                },
                "video": {
                    "description": "Video places a video call instead of a voice call. WhatsApp requires a\nvideo track for these, so voice is the supported path.",
                    "type": "boolean",
                    "example": false
                }
            }
        ...
        "github_com_EvolutionAPI_evolution-go_pkg_instance_service.ProxyTestResult": {
            "type": "object",
            "properties": {
                "anonymous": {
        ...
        "github_com_EvolutionAPI_evolution-go_pkg_sendMessage_service.ButtonStruct": {
            ...
            "properties": {
                ...
                "imageUrl": {
                    "description": "Optional image URL used as header for reply or CTA (url/call/copy) buttons. Not supported for pix.",
                    "type": "string"
                },
                "mentionAll": {
                ...
                "videoUrl": {
                    "description": "Optional video URL used as header for reply or CTA (url/call/copy) buttons. Not supported for pix.",
                    "type": "string"
                }
            }
        },
        ...
        "pkg_instance_handler.AddWebhookBody": {
            "type": "object",
            "required": [
                "url"
            ],
            "properties": {
                "url": {
                    "description": "URL that will receive the instance's events.",
                    "type": "string",
    ...
    "tags": [
        {
            "description": "Ciclo de vida da instancia: criar, conectar, QR, proxy, webhooks, logs.",
            "name": "Instance"
        },
        {
            "description": "Envio de mensagens — texto, midia, botoes, lista, carrossel, enquete, status.",
            "name": "Send Message"
        },
        {
            "description": "Acoes sobre mensagens ja enviadas: reagir, editar, apagar, marcar como lida.",
            "name": "Message"
        },
        {
            "description": "Conversas: presenca, arquivar, fixar, silenciar, historico.",
            "name": "Chat"
        },
        {
            "description": "Grupos: criar, participantes, permissoes, convites.",
            "name": "Group"
        },
        {
            "description": "Comunidades e seus grupos vinculados.",
            "name": "Community"
        },
        {
            "description": "Canais (newsletters).",
            "name": "Newsletter"
        },
        {
            "description": "Etiquetas do WhatsApp Business.",
            "name": "Label"
        },
        {
            "description": "Chamadas de voz: ligar, atender, desligar e audio bidirecional.",
            "name": "Call"
        },
        {
            "description": "Perfil, foto, status e privacidade da conta conectada.",
            "name": "User"
        },
        {
            "description": "Enquetes e seus votos.",
            "name": "Polls"
        },
        {
            "description": "Cerimonia WebAuthn usada quando a conta exige passkey para parear.",
            "name": "Passkey"
        }
    ]
}`
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "API HTTP para WhatsApp construida sobre whatsmeow, com suporte a multiplas\ninstancias, mensagens interativas, chamadas de voz, webhooks e MCP.\n\n## Autenticacao\n\nToda requisicao autenticada usa o header `apikey`. O valor depende do escopo:\n\n- **Chave global** (`GLOBAL_API_KEY`): administra instancias — criar, listar,\napagar, configurar proxy, ler logs. Sao as rotas sob `/instance` marcadas\ncomo admin.\n- **Token da instancia**: opera uma instancia — enviar mensagens, ler chats,\ngrupos, chamadas. O token e devolvido na criacao da instancia.\n\nUse o botao **Authorize** para informar a chave; ela sera enviada no header\n`apikey` em todas as chamadas de teste.\n\n## Webhooks\n\nCada instancia pode ter varias URLs de webhook (`/instance/webhooks/{id}`) e\ntodas recebem o mesmo payload. A entrega e assincrona, com ate 5 tentativas e\nespera exponencial. Respostas 4xx nao sao reenviadas — elas indicam recusa, nao\nindisponibilidade; 5xx, 408 e 429 sao reenviadas.\n\n## Formato dos erros\n\nFalhas retornam `{\"error\": \"mensagem\"}` com o status HTTP correspondente.",
